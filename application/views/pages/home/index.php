	...
	<div class="row">
		<div class="col-md-9">
			<div class="row">
				<div class="col-md-12">
					<div class="card mb-3">
						<div class="card-body" style="background-color:#1a1423;">
						<span style="color:#F4F1DE;">Kategori:<strong> <?= isset($category) ? $category : 'Semua Kategori' ?></strong></span>
							<span class="float-right" style="color:#F4F1DE;">
		...
		<div class="col-md-3">
			<div class="row">
				<div class="col-md-12">
					<div class="card mb-3">
						<div class="card-header"style="background-color:#1a1423;">
							<span style="color:#F4F1DE;">Pencarian</span>
						</div>
						<div class="card-body">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card mb-3">
						<div class="card-header"style="background-color:#1a1423;">
							<span style="color:#F4F1DE;">Kategori</span>
						</div>
